...
if __name__ == '__main__':
    ...
    plot = ['k--', 'color = black']
    Htf = control.tf([Lf*Cf,Cf*Rd, 1],[Cf*Rd, 1]) # This transfer function is approximating the complete plant transfer function to ensure the approximation is correct...
